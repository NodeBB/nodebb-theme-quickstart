	...
	<footer class="row">
		<aside class="col-md-4">
			<div class="py-3 ps-2">
				<a class="rounded-circle d-inline-block ps-2 pe-3" href="https://openbeta.io">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="current" viewBox="0 0 48 42"
			...
			<p>
				<span class="fw-semibold fs-5">OpenBeta</span><br>
				<span class="tracking-tight font-sm">Free climbing database built &amp; run by climbers.</span>
			</p>
		</aside>
		<nav class="col-md-2 d-flex flex-column gap-2">
			<header class="footer-title">Get involved</header><a class="link link-hover"
				href="https://collective.openbeta.io/get-involved">How to get involved</a>
		...
		<nav class="col-md-2 d-flex flex-column gap-2">
			...
			<a class="link link-hover"
				...
				class="link link-hover" href="https://twitter.com/openbetahq">Twitter</a>
		</nav>
		<nav class="col-md-2 d-flex flex-column gap-2">
			<header class="footer-title">The Org</header><a class="link link-hover"
				href="https://collective.openbeta.io/about">About us</a><a class="link link-hover"
				href="http://openbeta.io/blog/openbeta-vs-mountain-project-vs-thecrag">OpenBeta vs others</a><a
				class="link link-hover" href="https://openbeta.substack.com/">Our blog</a><a class="link link-hover"
				href="https://opencollective.com/openbeta">Make a donation</a><a class="link link-hover"
				href="https://opencollective.com/openbeta/contribute/t-shirt-31745">Buy a T-shirt</a><a
				class="link link-hover" href="/partner-with-us/">Become a Partner</a>
		</nav>
		<nav class="col-md-2 d-flex flex-column gap-2">
